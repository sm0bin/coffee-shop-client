        ...
        <div className='w-full md:w-1/4 lg:shadow-md mx-auto mt-16 p-4 md:p-12 rounded'>
            ...
            <form onSubmit={handleRegister} className="card-body p-0">
                ...
                <div className="form-control my-6">
                    <button className="btn btn-block bg-[#D2B48C] hover:bg-[#cb9a5b] font-rancho normal-case text-2xl  text-[#331A15] border-2 hover:border-[#331A15]">Sign Up</button>
                </div>
            </form>
            <h3>Already have an account? <Link className='font-semibold text-rose-500' to="/sign-in">Sign In</Link></h3>
